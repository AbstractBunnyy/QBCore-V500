...
Config.DeathTime = 100                                       -- How long the timer is for players to bleed out completely and respawn at the hospital
...
Config.HealthDamage = 30                                      -- Minumum damage done to health before checking for injuries
