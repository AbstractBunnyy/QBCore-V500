...
-- Google Docs Link
Config.sopLink = {
    ['police'] = 'https://docs.google.com/document/d/1VYkrJhDGjwFYN-PkLp0V_a7OP_T0c16JmMjo7AIVDqE/edit',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
    ['sast'] = '',
...
-- Google Docs Link
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/1Wn9lDG50M6V_5NAt-ihjwo0wRLhgQD8wHfwflzqNTmw/edit?usp=sharing',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
    ['sast'] = '',
...
Config.PenalCodeTitles = {
    ...
    [11] = 'Offenses Involving the Operation of a Vehicle',
}
...
Config.PenalCode = {
    ...
    [2] = {
        ...
        [20] = {title = 'Store Robbery', class = 'Felony', id = 'P.C. 2020', months = 25, fine = 1500, color = 'green', description = 'The action of taking property unlawfully from a place by force or threat of force.'},
        [21] = {title = 'Museum Robbery', class = 'Felony', id = 'P.C. 2021', months = 25, fine = 900, color = 'green', description = 'The action of taking property unlawfully from a place by force or threat of force.'},
    },
    [3] = {
    ...
    [4] = {
        ...
        [7] = {title = 'Trespassing on Government Property', class = 'Misdemeanor', id = 'P.C. 4006', months = 5, fine = 700, color = 'green', description = 'Trespassing on Government Property'},
        [8] = {title = 'Trespassing on Government Property', class = 'Felony', id = 'P.C. 4007', months = 25, fine = 1500, color = 'orange', description = 'Trespassing on Government Property'},
    },
    [5] = {
    ...
    [8] = {
        [1] = {title = 'Criminal Possession of Weapon Class 1', class = 'Felony', id = 'P.C. 8001', months = 10, fine = 500, color = 'green', description = 'Possession of a Class A firearm without licensing'},
        [2] = {title = 'Criminal Possession of Weapon Class 2', class = 'Felony', id = 'P.C. 8002', months = 15, fine = 1000, color = 'green', description = 'Possession of a Class B firearm without licensing'},
        [3] = {title = 'Criminal Possession of Weapon Class 3', class = 'Felony', id = 'P.C. 8003', months = 30, fine = 3500, color = 'green', description = 'Possession of a Class C firearm without licensing'},
        [4] = {title = 'Criminal Possession of Weapon Class 4', class = 'Felony', id = 'P.C. 8004', months = 25, fine = 1500, color = 'green', description = 'Possession of a Class D firearm without licensing'},
        ...
        [17] = {title = 'Discharge of a Firearm', class = 'Felony', id = 'P.C. 8016', months = 10, fine = 500, color = 'orange', description = 'Use of a weapon'},
    },
    [9] = {
    ...
    [11] = {
        [1] = {title = 'Illegal modifications on Vehicles', class = 'Infraction', id = 'P.C. 10001', months = 0, fine = 500, color = 'green', description = 'Illegal modifications on Vehicles such as tint,nos,armor,bptires'},
    }
}
