...
Config.Stores = {
    {
        ...
        points = {
            vector3(1688.369, 4816.293, 42.065),
            vector3(1700.243, 4817.771, 42.065),
            vector3(1698.487, 4831.38, 42.425),
            vector3(1686.704, 4829.464, 42.065)
        }
    },
    {
        type = "clothing", --portola drive
        coords = vector4(-709.547, -152.846, 37.415, 112.61),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-699.735, -156.853, 37.415),
            vector3(-710.679, -163.652, 37.415),
            vector3(-720.011, -148.311, 37.415),
            vector3(-709.111, -141.544, 37.415)
        }
    },
    {
        type = "clothing", --san andreas
        coords = vector4(-1192.61, -768.4, 17.32, 216.6),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-1191.137, -764.333, 17.316),
            vector3(-1184.942, -771.785, 17.333),
            vector3(-1197.56, -781.099, 17.333),
            vector3(-1203.642, -773.357, 17.315)
        }
    },
    {
        type = "clothing", --sinner street
        coords = vector4(425.91, -801.03, 29.49, 177.79),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(419.144, -812.035, 29.493),
            vector3(431.196, -812.069, 29.493),
            vector3(431.244, -798.351, 29.853),
            vector3(419.368, -798.62, 29.493)
        }
    },
    {
        type = "clothing", --las lagunas
        coords = vector4(-168.73, -301.41, 39.73, 238.67),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-167.306, -293.135, 39.733),
            vector3(-154.844, -296.513, 39.733),
            vector3(-160.306, -313.619, 39.733),
            vector3(-172.842, -309.302, 39.733)
        }
    },
    {
        type = "clothing", --innocence boulevard
        coords = vector4(75.39, -1398.28, 29.38, 6.73),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(81.401, -1400.779, 29.378),
            vector3(69.709, -1400.798, 29.738),
            vector3(69.757, -1387.077, 29.378),
            vector3(81.521, -1387.303, 29.378)
        }
    },
    {
        type = "clothing", --south rockford drive
        coords = vector4(-827.39, -1075.93, 11.33, 294.31),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-820.164, -1065.773, 11.33),
            vector3(-814.092, -1076.186, 11.33),
            vector3(-825.948, -1082.737, 11.33),
            vector3(-832.063, -1072.592, 11.69)
        }
    },
    {
        type = "clothing", --cougar avenue
        coords = vector4(-1445.86, -240.78, 49.82, 36.17),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-1460.754, -240.032, 49.799),
            vector3(-1450.902, -248.334, 49.824),
            vector3(-1439.242, -234.699, 49.823),
            vector3(-1449.052, -226.419, 49.798)
        }
    },
    {
        type = "clothing", --Paleto Boulevard
        coords = vector4(9.22, 6515.74, 31.88, 131.27),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(14.457, 6513.638, 32.24),
            vector3(6.079, 6522.16, 31.88),
            vector3(-3.519, 6513.154, 31.88),
            vector3(4.386, 6504.348, 31.88)
        }
    },
    {
        type = "clothing", --Route68
        coords = vector4(615.35, 2762.72, 42.09, 170.51),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(622.892, 2751.825, 42.088),
            vector3(613.191, 2750.985, 42.088),
            vector3(611.906, 2764.474, 42.088),
            vector3(621.847, 2767.649, 42.088)
        }
    },
    {
        type = "clothing", --route68
        ...
        usePoly = true,
        points = {
            vector3(1202.502, 2715.848, 38.225),
            vector3(1202.358, 2703.93, 38.225),
            vector3(1188.792, 2704.201, 38.225),
            vector3(1188.783, 2715.892, 38.585)
        }
    },
    {
        type = "clothing", --chumash
        coords = vector4(-3171.32, 1043.56, 20.86, 334.3),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-3179.579, 1042.972, 20.863),
            vector3(-3173.294, 1057.226, 20.863),
            vector3(-3164.134, 1053.705, 20.863),
            vector3(-3169.632, 1041.218, 20.863)
        }
    },
    {
        type = "clothing", --route68 zancudo
        coords = vector4(-1105.52, 2707.79, 19.11, 317.19),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-1103.293, 2700.821, 19.11),
            vector3(-1111.113, 2709.442, 19.47),
            vector3(-1100.855, 2718.639, 19.11),
            vector3(-1093.198, 2709.737, 19.11)
        }
    },
  --  {
    --    type = "clothing",
  ...
  --      usePoly = false,
    ...
    --},
    {
        type = "surgeon", --mtzonah
        coords = vector4(-452.154, -320.921, 34.911, 302.751),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-446.619, -325.62, 35.508),
            vector3(-454.081, -324.984, 34.911),
            vector3(-456.969, -319.653, 34.911),
            vector3(-449.115, -315.684, 34.911)
        }
    },
    {
        type = "surgeon", --sandy
        coords = vector4(1660.055, 3644.07, 35.34, 295.915),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(1658.76, 3641.967, 35.34),
            vector3(1657.865, 3643.508, 35.34),
            vector3(1661.628, 3646.554, 35.34),
            vector3(1662.261, 3644.023, 35.34)
        }
    },
    {
        type = "surgeon", --paleto
        coords = vector4(-258.509, 6310.687, 32.452, 314.618),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-259.338, 6308.414, 32.452),
            vector3(-260.602, 6309.679, 32.452),
            vector3(-258.034, 6313.32, 32.452),
            vector3(-256.763, 6310.988, 32.452)
        }
    },
    {
        type = "surgeon", --pillbox
